    ...
    if (http_request.readyState == 4) {
        if (http_request.status == 200) {
           ...
           // alert(responceString);
            document.getElementById("gName").innerHTML = responceString;
...
<!--onload="getSerialno()"-->
<body onload="xmlhttpPost('http://localhost:8080/RestWebService1/rest/getGuestName?hotelid=F601&roomno=109');return false;" >

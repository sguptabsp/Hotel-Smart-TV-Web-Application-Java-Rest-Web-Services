...
public class InvoiceDao {
	...
	public InvoiceBean getInvoiceDetail(InvoiceBean invoice) throws SQLException
	{
		...
		String query1 = "Select * from Booking3 where RoomNo='"+invoice.getRoomNo()+"' AND Cust_Name ='"+invoice.getName()+"' AND AVALABILITY = 'N'";
		...
		String query2 = "UPDATE Booking3 SET CheckOut_Date=TO_DATE('" + dt+ "', 'yy-MM-dd'), Avalability ='Y',TotalCharges='"+ invoice.getTotalCharges()+"' where RoomNo='"+invoice.getRoomNo()+"'";

...
public class CheckOutServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("b1").equals("Check Out"))
		{
			...
			invoice.setCheckInDate(DateUtility.getDate(checkInDate, "dd-MM-yyyy"));
			invoice.setCheckOutDate(DateUtility.getDate(checkOutDate, "dd-MM-yyyy"));
			...
			if(invoice==null)
			{
				String errorMsg = "Either wrong detail of Guest or Guest already checked out!!";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("b1").equals("makepayment"))
		{

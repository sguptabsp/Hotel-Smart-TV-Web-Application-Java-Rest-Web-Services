...
function VBDNUMpad(container_id, callback_ref, font_name, font_size,
...
VBDNUMpad.prototype = {
                       ...
                       show_click, click_font_color, click_bg_color, click_border_color, do_embed, do_gap)
  {
    ...
    if(!exists)
    {
      ...
      VBDNUMpad.kbArray[container_id] = this;
    }
  ...
  _create_numpad: function(container_id, parent)
  {
	...
	var randkeyArr=new Array();

	for (var ctr=0; ctr<10;ctr++ )
	{

		var arrlen=keyArr.length;
		var keyval=parseInt(Math.random()*arrlen);
		randkeyArr[ctr]=keyArr[keyval];
		keyArr.splice(keyval,1);	
    ...
    kb_pad_7.innerHTML = randkeyArr[0];
    ...
    kb_pad_8.innerHTML = randkeyArr[1];
    ...
    kb_pad_9.innerHTML = randkeyArr[2];
  ...
  _generic_callback_proc: function(event)
  {
    ...
    var vpad = VBDNUMpad.kbArray[container_id];

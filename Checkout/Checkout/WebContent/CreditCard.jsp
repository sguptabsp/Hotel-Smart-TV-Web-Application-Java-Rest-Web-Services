...
<form name="form1" method="post" action="/pgidsk/PGICommonGateway">
...
<br>
  ...
  <DIV id="numpad1"></DIV>  </td>
     ...
     <tr>
       ...
       <td><input name="image" type="image" style="width:95px;" onClick="cancelForm()"  src="images/cancel_button_new.gif" alt="Cancel" ></td>

       <td colspan="2" valign="middle"><input  name="paynow" type="image" style="width:145px" onClick="return validateForm()" value="" src="images/pay_button_new.gif" alt="Make Payment"></td>
       </tr>
   </table></TD>
